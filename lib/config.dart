class Config {
  ...
  /// 用户协议地址
  static const String agreementUrl = 'https://cdn.itvapp.net/itvapp_live_tv/agreement.json';
  /// 用户协议备用地址
  static const String backupagreementUrl = 'https://www.itvapp.net/itvapp_live_tv/agreement.json';
  
  /// 简体中文播放列表地址
  static const String defaultPlaylistZhCN = 'https://cdn.itvapp.net/itvapp_live_tv/playlists_zh2.m3u';
  /// 繁体中文播放列表地址
  static const String defaultPlaylistZhTW = 'https://cdn.itvapp.net/itvapp_live_tv/playlists_tw2.m3u'; 
  /// 其它语言播放列表地址
  static const String defaultPlaylistOther = 'https://cdn.itvapp.net/itvapp_live_tv/playlists_other2.m3u';

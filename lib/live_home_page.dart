...
class _LiveHomePageState extends State<LiveHomePage> {
  ...
  // 执行频道切换的核心方法
  Future<void> _executeSwitchChannel(PlayModel channel, int sourceIndex, String requestId) async {
    // 检查请求有效性

...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "downloadSuccess": MessageLookupByLibrary.simpleMessage("下載新版本完成，請安裝！"),
        "downloadFailed": MessageLookupByLibrary.simpleMessage("下載新版本失敗，請稍後重試"),
        "platformNotSupported": MessageLookupByLibrary.simpleMessage("當前系統不支持應用內更新"),

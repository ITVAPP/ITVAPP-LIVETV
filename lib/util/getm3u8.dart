...
class GetM3U8 {
  ...
  GetM3U8({
    ...
    this.timeoutSeconds = 9,
  }) : baseUri = Uri.parse(url),  // 在构造时就解析 Uri
      ...
      // 确定是否是hash路由
      isHashRoute = baseUri.fragment.isNotEmpty;
  ...
  Future<void> dispose() async {
    ...
    // 清理首次加载标记
    String mapKey = baseUri.toString();
    _hashFirstLoadMap.remove(mapKey);
